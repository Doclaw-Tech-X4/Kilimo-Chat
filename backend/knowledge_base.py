...
class KnowledgeBase:
    ...
    def _load_verified_facts(self):
        ...
        verified_facts = [
            # MAIZE FACTS (10)
            KnowledgeFact("m1", "maize", "planting", 
                ...
                "KALRO", 1.0, ["maize", "planting", "seasons", "timing"]),
            
            KnowledgeFact("m2", "maize", "spacing",
                ...
                "KALRO", 1.0, ["maize", "spacing", "planting"]),
            
            KnowledgeFact("m3", "maize", "fertilizer",
                ...
                "KALRO", 1.0, ["maize", "fertilizer", "DAP", "CAN"]),
            
            KnowledgeFact("m4", "maize", "pests",
                ...
                "KALRO/KEPHIS", 1.0, ["maize", "Fall Armyworm", "pests", "control"]),
            
            KnowledgeFact("m5", "maize", "disease",
                ...
                "KALRO", 0.95, ["maize", "streak virus", "disease", "leafhopper"]),
            
            KnowledgeFact("m6", "maize", "harvest",
                ...
                "KALRO", 1.0, ["maize", "harvest", "dent stage"]),
            
            KnowledgeFact("m7", "maize", "storage",
                ...
                "KALRO/KEPHIS", 1.0, ["maize", "storage", "aflatoxin", "post-harvest"]),
            
            KnowledgeFact("m8", "maize", "variety",
                ...
                "KALRO", 1.0, ["maize", "varieties", "highlands", "seeds"]),
            
            KnowledgeFact("m9", "maize", "variety",
                ...
                "KALRO", 1.0, ["maize", "drought", "varieties", "dry areas"]),
            
            KnowledgeFact("m10", "maize", "water",
                ...
                "KALRO", 0.95, ["maize", "irrigation", "water", "drip"]),
            
            # BEANS FACTS (10)
            KnowledgeFact("b1", "beans", "planting",
                ...
                "KALRO", 1.0, ["beans", "planting", "seasons", "timing"]),
            
            KnowledgeFact("b2", "beans", "spacing",
                ...
                "KALRO", 1.0, ["beans", "spacing", "bush", "climbing"]),
            
            KnowledgeFact("b3", "beans", "fertilizer",
                ...
                "KALRO", 1.0, ["beans", "fertilizer", "nitrogen", "DAP"]),
            
            KnowledgeFact("b4", "beans", "pests",
                ...
                "KALRO", 1.0, ["beans", "pests", "bean fly", "aphid", "bruchid"]),
            
            KnowledgeFact("b5", "beans", "disease",
                ...
                "KALRO", 0.95, ["beans", "angular leaf spot", "disease"]),
            
            KnowledgeFact("b6", "beans", "varieties",
                ...
                "KALRO", 1.0, ["beans", "varieties", "market", "GLP"]),
            
            KnowledgeFact("b7", "beans", "harvest",
                ...
                "KALRO", 1.0, ["beans", "harvest", "pods"]),
            
            KnowledgeFact("b8", "beans", "rotation",
                ...
                "KALRO", 1.0, ["beans", "rotation", "maize", "soil fertility"]),
            
            KnowledgeFact("b9", "beans", "support",
                ...
                "KALRO", 0.95, ["beans", "climbing", "staking", "trellis"]),
            
            KnowledgeFact("b10", "beans", "storage",
                ...
                "KALRO", 1.0, ["beans", "storage", "PICS bags", "neem"]),
            
            # TOMATOES FACTS (10)
            KnowledgeFact("t1", "tomatoes", "planting",
                ...
                "KALRO", 0.95, ["tomatoes", "planting", "seedlings", "transplant"]),
            
            KnowledgeFact("t2", "tomatoes", "spacing",
                ...
                "KALRO", 1.0, ["tomatoes", "spacing", "determinate", "indeterminate"]),
            
            KnowledgeFact("t3", "tomatoes", "fertilizer",
                ...
                "KALRO", 1.0, ["tomatoes", "fertilizer", "compost", "calcium"]),
            
            KnowledgeFact("t4", "tomatoes", "pests",
                ...
                "KEPHIS/KALRO", 1.0, ["tomatoes", "Tuta absoluta", "leaf miner", "pests"]),
            
            KnowledgeFact("t5", "tomatoes", "disease",
                ...
                "KALRO", 1.0, ["tomatoes", "late blight", "disease", "fungicide"]),
            
            KnowledgeFact("t6", "tomatoes", "water",
                ...
                "KALRO", 0.95, ["tomatoes", "irrigation", "water", "drip", "mulch"]),
            
            KnowledgeFact("t7", "tomatoes", "varieties",
                ...
                "KALRO", 1.0, ["tomatoes", "varieties", "Roma", "market"]),
            
            KnowledgeFact("t8", "tomatoes", "pruning",
                ...
                "KALRO", 0.95, ["tomatoes", "pruning", "suckers", "indeterminate"]),
            
            KnowledgeFact("t9", "tomatoes", "greenhouse",
                ...
                "KALRO", 0.95, ["tomatoes", "greenhouse", "protected cultivation"]),
            
            KnowledgeFact("t10", "tomatoes", "harvest",
                ...
                "KALRO", 1.0, ["tomatoes", "harvest", "stages", "breaker"]),
            
            # AVOCADOS FACTS (10)
            KnowledgeFact("a1", "avocados", "planting",
                ...
                "KALRO", 1.0, ["avocados", "planting", "timing", "rains"]),
            
            KnowledgeFact("a2", "avocados", "spacing",
                ...
                "KALRO", 1.0, ["avocados", "spacing", "Hass", "Fuerte", "orchard"]),
            
            KnowledgeFact("a3", "avocados", "fertilizer",
                ...
                "KALRO", 0.95, ["avocados", "fertilizer", "NPK", "micronutrients"]),
            
            KnowledgeFact("a4", "avocados", "pollination",
                ...
                "KALRO", 1.0, ["avocados", "pollination", "Type A", "Type B", "cross-pollination"]),
            
            KnowledgeFact("a5", "avocados", "pruning",
                ...
                "KALRO", 0.95, ["avocados", "pruning", "training", "canopy"]),
            
            KnowledgeFact("a6", "avocados", "pests",
                ...
                "KEPHIS/KALRO", 1.0, ["avocados", "pests", "codling moth", "thrips", "fruit fly"]),
            
            KnowledgeFact("a7", "avocados", "disease",
                ...
                "KALRO", 1.0, ["avocados", "root rot", "Phytophthora", "drainage"]),
            
            KnowledgeFact("a8", "avocados", "harvest",
                ...
                "KALRO", 1.0, ["avocados", "harvest", "Hass", "Fuerte", "maturity"]),
            
            KnowledgeFact("a9", "avocados", "rootstock",
                ...
                "KALRO", 0.95, ["avocados", "rootstock", "Velvick", "Duke 7", "grafting"]),
            
            KnowledgeFact("a10", "avocados", "export",
                ...
                "KEPHIS/KALRO", 1.0, ["avocados", "export", "GlobalGAP", "KEPHIS", "standards"]),
            
            # DAIRY FACTS (10)
            KnowledgeFact("d1", "dairy", "breeding",
                ...
                "KALRO", 1.0, ["dairy", "breeds", "Friesian", "Ayrshire", "Jersey", "milk"]),
            
            KnowledgeFact("d2", "dairy", "feeding",
                ...
                "KALRO", 1.0, ["dairy", "feeding", "napier", "dairy meal", "nutrition"]),
            
            KnowledgeFact("d3", "dairy", "milking",
                ...
                "KALRO", 1.0, ["dairy", "milking", "frequency", "timing"]),
            
            KnowledgeFact("d4", "dairy", "mastitis",
                ...
                "KALRO/Vet Dept", 1.0, ["dairy", "mastitis", "udder health", "antibiotics"]),
            
            KnowledgeFact("d5", "dairy", "heat",
                ...
                "KALRO", 0.95, ["dairy", "heat detection", "fertility", "AI"]),
            
            KnowledgeFact("d6", "dairy", "calf",
                ...
                "KALRO", 1.0, ["dairy", "calf", "colostrum", "newborn", "weaning"]),
            
            KnowledgeFact("d7", "dairy", "shed",
                ...
                "KALRO", 0.95, ["dairy", "housing", "shed", "construction"]),
            
            KnowledgeFact("d8", "dairy", "fodder",
                ...
                "KALRO", 1.0, ["dairy", "fodder", "napier", "desmodium", "lucerne"]),
            
            KnowledgeFact("d9", "dairy", "economics",
                ...
                "KALRO", 0.95, ["dairy", "economics", "profit", "break-even"]),
            
            KnowledgeFact("d10", "dairy", "record",
                ...
                "KALRO", 1.0, ["dairy", "records", "management", "productivity"]),
        ]
    ...
    def _generate_embeddings(self):
        ...
        texts = [f"{f.question} {f.answer} {' '.join(f.tags or [])}" for f in self.facts]
    ...
    def search(self, query: str, top_k: int = 3, threshold: float = 0.7) -> List[Tuple[KnowledgeFact, float]]:
        """
    ...
    def _semantic_search(self, query: str, top_k: int, threshold: float) -> List[Tuple[KnowledgeFact, float]]:
    ...
    def _keyword_search(self, query: str, top_k: int, threshold: float) -> List[Tuple[KnowledgeFact, float]]:
        ...
        for fact in self.facts:
            ...
            fact_text = f"{fact.question} {fact.answer} {' '.join(fact.tags or [])}".lower()
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "embeddings_available": EMBEDDINGS_AVAILABLE and any(f.embedding for f in self.facts),
...
def search_knowledge(query: str, top_k: int = 3, threshold: float = 0.7) -> Dict[str, Any]:
    """
